"""Buyam-Sellam — thin UI/simulation layer.

All game logic lives in the model classes (Table, MarketBoard, Player).
This file only handles print/input orchestration.

New game mechanics:
- Per-market strategy: players order markets + announce buy/sell/skip per market
- Turn order: initial dice roll, highest goes first, completes ALL markets
- Per-market dice: each market entry = new dice roll
- Buy: dice_price > market_price → buy at market price
